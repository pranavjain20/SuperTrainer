...
async def test_404_returns_error_format(client):
...
async def test_422_validation_returns_error_format(client):
...
async def test_422_invalid_uuid_returns_error_format(client):
...
async def test_error_response_has_no_detail_key(client):
